...
export default function TiktokDownloader() {
  ...
  const currentConfig = tiktokConfig[format];
  ...
  const isValidTiktokUrl = (url) => {
    const tiktokRegex = /^https?:\/\/(www\.)?(tiktok\.com|story\.tiktok\.com|t\.tiktok\.com)\/.+/;
  ...
  return (
    <>
      ...
      <TiktokMannual format={format} />
      <TiktokFeature format={format} />
      <TiktokFaq format = {format} />
    </>
  )
}